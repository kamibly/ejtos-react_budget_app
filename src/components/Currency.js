...
const Currency = () => {
  const {dispatch } = useContext(AppContext);
   ...
   return (
      ...
      <select className='btn btn-success dropdown-toggle' name='hover_color'id="currency" onChange={(event)=>changeCurrency(event.target.value)} style={{ marginLeft: '1rem' , backgroundColor:'#33FF49', color:'white'}}>
